<?php
/**
 * Script to clean the www directory
...
// Define the path to the www directory
$wwwDir = '/home/pixicoq/www';
...
if (php_sapi_name() !== 'cli') {
    ...
    if (!isset($_GET['confirm']) || $_GET['confirm'] !== 'yes') {
        echo "<h2>Danger: This script cleans the www directory!</h2>";
...
echo "<pre>\n";
echo "Starting cleaning of www directory...\n";
echo "Target directory: $wwwDir\n\n";

// Check if directory exists before attempting deletion
if (file_exists($wwwDir)) {
    echo "Directory found. Starting cleaning process...\n";
    
    // Attempt to delete the directory
    if (deleteDirectory($wwwDir)) {
        echo "\nSUCCESS: www directory and all contents have been deleted.\n";
        
        // Recreate the empty www directory
        if (mkdir($wwwDir)) {
            echo "Recreated empty www directory.\n";
        } else {
            echo "Failed to recreate www directory.\n";
        }
    } else {
        echo "\nERROR: Failed to clean www directory completely.\n";
    }
} else {
    echo "Directory does not exist: $wwwDir\n";
