...
* @see app/Http/Controllers/ServicePageController.php:10
...
* @see app/Http/Controllers/ServicePageController.php:23
* @route '/api/service-pages'
*/
...
* @see app/Http/Controllers/ServicePageController.php:69
...
* @see app/Http/Controllers/ServicePageController.php:120
* @route '/api/service-pages/{id}'
*/
...
* @see app/Http/Controllers/ServicePageController.php:0
* @route '/{category}/{slug}'
*/
