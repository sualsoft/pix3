...
const loadData = async () => {
    try {
        ...
        if (res.data.drone_videos) {
            form.value = res.data.drone_videos;
        }
    } catch (e) {
        console.error(e);
    }
...
const save = async () => {
    ...
    try {
        await axios.post('/api/settings/drone-videos', form.value);
        message.value = '✅ Vidéos Drone sauvegardées !';
    } catch (e) {
            ...
            <div class="mx-auto max-w-5xl">
                <div class="mb-8 text-center">
                    ...
                    <p class="text-gray-600">
                        Gérez la grille de vidéos pour la page Drone.
                    </p>
                </div>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <input
                                                v-model="video.alt"
                                                type="text"
                                                class="w-full rounded border p-2 text-sm text-gray-500"
                                            />
                                        </div>
                                    </div>
                                    <div>
