...
const loadData = async () => {
    try {
        ...
        // Check if portfolio_seo exists in the response
        if (data.portfolio_seo) {
            form.value.content = data.portfolio_seo.content || '';
            form.value.meta_title = data.portfolio_seo.meta_title || '';
            form.value.meta_description =
                data.portfolio_seo.meta_description || '';
            form.value.keywords = data.portfolio_seo.keywords || '';
            form.value.og_title = data.portfolio_seo.og_title || '';
            form.value.og_description = data.portfolio_seo.og_description || '';
            form.value.og_image_preview = data.portfolio_seo.og_image || '';
            form.value.og_type = data.portfolio_seo.og_type || 'website';
            form.value.twitter_card =
                data.portfolio_seo.twitter_card || 'summary_large_image';
            form.value.twitter_title = data.portfolio_seo.twitter_title || '';
            form.value.twitter_description =
                data.portfolio_seo.twitter_description || '';
            form.value.twitter_image_preview =
                data.portfolio_seo.twitter_image || '';
        }
    } catch (error) {
            ...
            <div class="mx-auto max-w-4xl">
                <div class="mb-8 text-center">
                    <h1 class="text-3xl font-bold text-gray-800 md:text-4xl">
                        Contenu SEO de la page Portfolio
                    </h1>
                    <p class="mt-2 text-gray-600">
                        Modifiez le contenu supplémentaire pour améliorer le
                        référencement naturel de la page Portfolio.
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-2 text-blue-100">
                            Ce contenu sera affiché en bas de la page Portfolio,
                    ...
                    <div class="p-6 md:p-8">
                        <div class="mb-6">
                            ...
                            <textarea
                                ...
                                placeholder="Ajoutez du contenu supplémentaire pour améliorer le référencement naturel (SEO) de la page Portfolio..."
                            ></textarea>
                            <p class="mt-1 text-xs text-gray-500">
                                Ce contenu peut inclure des mots-clés
                                pertinents, des informations détaillées sur vos
                                services de portfolio, ou tout autre contenu
