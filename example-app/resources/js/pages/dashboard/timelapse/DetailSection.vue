...
const loadData = async () => {
    try {
        ...
        if (res.data.timelapse_detail) {
            form.value = res.data.timelapse_detail;
...
// Handle Image Upload (Generic for any of the 3 slots)
...
const save = async () => {
    ...
    try {
        await axios.post('/api/settings/timelapse-detail', form.value);
        message.value = '✅ Détails sauvegardés !';
    } catch (e) {
            ...
            <div class="mx-auto max-w-5xl">
                <div class="mb-8 text-center">
                    ...
                    <p class="text-gray-600">
                        Modifiez le texte "Qu'est-ce qu'un timelapse ?" et les
                        images.
                    </p>
                </div>
