    ...
    try {
        ...
        if (response.ok) {
            ...
            if (result.errors) {
                ...
                message.value =
                    '❌ Error: ' + (result.message || 'Failed to add section');
            }
        }
    } catch (error) {
        message.value = '❌ Network error: ' + error.message;
...
const deleteSection = async (sectionId) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            message.value =
                '❌ Error: ' + (result.message || 'Failed to delete section');
        }
    } catch (error) {
        message.value = '❌ Network error: ' + error.message;
...
const refreshMainContent = async () => {
    ...
    try {
        ...
        const refreshResponse = await fetch(
            `/api/user-project/${data.id}/refresh`,
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
        ...
        if (refreshResponse.ok) {
            ...
            if (result.errors) {
                ...
                message.value =
                    '❌ Error: ' +
                    (result.message || 'Failed to refresh content');
            }
        }
    } catch (error) {
        message.value = '❌ Network error: ' + error.message;
...
const createFromCurrentTemplate = async () => {
    ...
    try {
        ...
        if (templateResponse.ok) {
            message.value =
                '✅ New page created successfully from current content!';
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">
                    Manage your main dashboard page content
                </p>
            </div>
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-1 text-indigo-100">
                            Manage existing content sections
                        </p>
                    </div>
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <div v-else class="py-8 text-center text-gray-500">
                            ...
                            <p class="mt-2 text-sm">
                                Add your first section using the "Add New
                                Section" tab.
                            </p>
                        </div>
                    </div>
            ...
            <div v-show="activeTab === 'add'" class="space-y-6">
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-1 text-indigo-100">
                            Create a new section for your dashboard
                        </p>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                />
                            </div>
