...
const loadData = async () => {
    try {
        ...
        if (data.drone_hero) {
            form.value.title = data.drone_hero.title || '';
            form.value.bg_image = data.drone_hero.bg_image || '';
        }
    } catch (error) {
                    ...
                    <div class="space-y-8 p-6 md:p-8">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <div
                                    class="absolute inset-0 flex items-center justify-center bg-black/10 transition group-hover:opacity-100"
                                >
                                    <label
