...
function assignValue(object, key2, value) {
  ...
  if (!(hasOwnProperty5.call(object, key2) && eq_default(objValue, value)) || value === void 0 && !(key2 in object)) {
...
var assign = createAssigner_default(function(object, source) {
  ...
  for (var key2 in source) {
    if (hasOwnProperty9.call(source, key2)) {
      assignValue_default(object, key2, source[key2]);
    }
  }
});
...
var bindAll = flatRest_default(function(object, methodNames) {
  arrayEach_default(methodNames, function(key2) {
    ...
    baseAssignValue_default(object, key2, bind_default(object[key2], object));
  });
  return object;
});
...
var bindKey = baseRest_default(function(object, key2, partials) {
  var bitmask = WRAP_BIND_FLAG9 | WRAP_BIND_KEY_FLAG6;
  if (partials.length) {
    var holders = replaceHolders_default(partials, getHolder_default(bindKey));
    bitmask |= WRAP_PARTIAL_FLAG5;
  }
  return createWrap_default(key2, bitmask, object, partials, holders);
});
bindKey.placeholder = {};
...
function baseConformsTo(object, source, props) {
  ...
  while (length--) {
    ...
    if (value === void 0 && !(key2 in object) || !predicate(value)) {
      return false;
    }
  }
  return true;
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto21[key2]) && !hasOwnProperty18.call(object, key2)) {
...
function baseFunctions(object, props) {
  return arrayFilter_default(props, function(key2) {
    return isFunction_default(object[key2]);
  });
}
...
function baseHas(object, key2) {
  return object != null && hasOwnProperty20.call(object, key2);
}
...
function baseInverter(object, setter, iteratee2, accumulator) {
  baseForOwn_default(object, function(value, key2, object2) {
...
function mapKeys(object, iteratee2) {
  ...
  baseForOwn_default(object, function(value, key2, object2) {
    baseAssignValue_default(result2, iteratee2(value, key2, object2), value);
  });
  return result2;
}
...
function mapValues(object, iteratee2) {
  ...
  iteratee2 = baseIteratee_default(iteratee2, 3);
  baseForOwn_default(object, function(value, key2, object2) {
    baseAssignValue_default(result2, key2, iteratee2(value, key2, object2));
  });
  return result2;
}
...
function customDefaultsAssignIn(objValue, srcValue, key2, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto27[key2]) && !hasOwnProperty23.call(object, key2)) {
    return srcValue;
  }
  return objValue;
}
...
var Config = class {
  ...
  get(key2) {
    return has_default(this.config, key2) ? get_default(this.config, key2) : get_default(this.defaults, key2);
  }
  set(keyOrValues, value) {
    if (typeof keyOrValues === "string") {
      ...
      Object.entries(keyOrValues).forEach(([key2, val]) => {
        set_default(this.config, key2, val);
      });
    }
  }
};
...
var fireBeforeUpdateEvent = (page22) => {
  return fireEvent("beforeUpdate", { detail: { page: page22 } });
};
var fireNavigateEvent = (page22) => {
  return fireEvent("navigate", { detail: { page: page22 } });
};
...
var fireSuccessEvent = (page22) => {
  return fireEvent("success", { detail: { page: page22 } });
};
...
var PrefetchedRequests = class {
  ...
  getShortestOncePropTtl(page22) {
    const expiryTimestamps = Object.values(page22.onceProps ?? {}).map((onceProp) => onceProp.expiresAt).filter((expiresAt) => !!expiresAt);
...
function objectToFormData(source, form = new FormData(), parentKey = null, queryStringArrayFormat = "brackets") {
  ...
  for (const key2 in source) {
    if (Object.prototype.hasOwnProperty.call(source, key2)) {
      append(form, composeKey(parentKey, key2, "indices"), source[key2], queryStringArrayFormat);
    }
  }
  return form;
}
function composeKey(parent2, key2, format) {
  if (!parent2) {
    return key2;
  }
  return format === "brackets" ? `${parent2}[]` : `${parent2}[${key2}]`;
}
function append(form, key2, value, format) {
  if (Array.isArray(value)) {
    return Array.from(value.keys()).forEach(
      (index) => append(form, composeKey(key2, index.toString(), format), value[index], format)
    );
...
var CurrentPage = class {
  ...
  set(page22, {
    ...
    if (Object.keys(page22.deferredProps || {}).length) {
      this.pendingDeferredProps = {
        deferredProps: page22.deferredProps,
        component: page22.component,
        url: page22.url
      };
    }
    this.componentId = {};
    const componentId = this.componentId;
    if (page22.clearHistory) {
      history.clear();
    }
    return this.resolve(page22.component).then((component2) => {
      if (componentId !== this.componentId) {
        return;
      }
      page22.rememberedState ?? (page22.rememberedState = {});
      const isServer2 = typeof window === "undefined";
      const location = !isServer2 ? window.location : new URL(page22.url);
      const scrollRegions = !isServer2 && preserveScroll ? history.getScrollRegions() : [];
      replace2 = replace2 || isSameUrlWithoutHash(hrefToUrl(page22.url), location);
      return new Promise((resolve) => {
        replace2 ? history.replaceState(page22, () => resolve(null)) : history.pushState(page22, () => resolve(null));
      }).then(() => {
        const isNewComponent = !this.isTheSame(page22);
        if (!isNewComponent && Object.keys(page22.props.errors || {}).length > 0) {
          viewTransition = false;
        }
        this.page = page22;
        this.cleared = false;
        ...
        return this.swap({
          ...
          if (this.pendingDeferredProps && this.pendingDeferredProps.component === page22.component && this.pendingDeferredProps.url === page22.url) {
            eventHandler.fireInternalEvent("loadDeferredProps", this.pendingDeferredProps.deferredProps);
          }
          this.pendingDeferredProps = null;
          if (!replace2) {
            fireNavigateEvent(page22);
          }
        });
      });
    });
  ...
  setQuietly(page22, {
    ...
    return this.resolve(page22.component).then((component2) => {
      this.page = page22;
      this.cleared = false;
      history.setCurrent(page22);
      return this.swap({ component: component2, page: page22, preserveState, viewTransition: false });
    });
  }
  clear() {
    this.cleared = true;
  ...
  swap({
    ...
    const doSwap = () => this.swapComponent({ component: component2, page: page22, preserveState });
  ...
  isTheSame(page22) {
    return this.page.component === page22.component;
  }
  on(event, callback) {
...
var History = class {
  ...
  pushState(page22, cb = null) {
    ...
    this.current = page22;
    queue.add(() => {
      return this.getPageData(page22).then((data) => {
        const doPush = () => this.doPushState({ page: data }, page22.url).then(() => cb?.());
        if (isChromeIOS) {
          return new Promise((resolve) => {
  ...
  clonePageProps(page22) {
    try {
      structuredClone(page22.props);
      return page22;
    } catch {
      return {
        ...page22,
        props: cloneDeep_default(page22.props)
      };
    }
  }
  getPageData(page22) {
    const pageWithClonedProps = this.clonePageProps(page22);
    return new Promise((resolve) => {
      return page22.encryptHistory ? encryptHistory(pageWithClonedProps).then(resolve) : resolve(pageWithClonedProps);
    });
  }
  processQueue() {
  ...
  decrypt(page22 = null) {
    if (isServer) {
      return Promise.resolve(page22 ?? page.get());
    }
    const pageData = page22 ?? window.history.state?.page;
  ...
  replaceState(page22, cb = null) {
    ...
    queue.add(() => {
      return this.getPageData(page22).then((data) => {
        const doReplace = () => this.doReplaceState({ page: data }, page22.url).then(() => cb?.());
        if (isChromeIOS) {
          return new Promise((resolve) => {
...
var RequestParams = class _RequestParams {
  ...
  setPreserveOptions(page22) {
    this.params.preserveScroll = _RequestParams.resolvePreserveOption(this.params.preserveScroll, page22);
    this.params.preserveState = _RequestParams.resolvePreserveOption(this.params.preserveState, page22);
  }
  runCallbacks() {
  ...
  static resolvePreserveOption(value, page22) {
    if (typeof value === "function") {
      return value(page22);
    }
    if (value === "errors") {
      return Object.keys(page22.props.errors || {}).length > 0;
    }
    return value;
  }
};
var modal_default = {
  ...
  createIframeAndPage(html) {
    ...
    const page22 = document.createElement("html");
    page22.innerHTML = html;
    page22.querySelectorAll("a").forEach((a) => a.setAttribute("target", "_top"));
    const iframe = document.createElement("iframe");
    iframe.style.backgroundColor = "white";
    iframe.style.borderRadius = "5px";
    iframe.style.width = "100%";
    iframe.style.height = "100%";
    return { iframe, page: page22 };
  },
  show(html) {
    const { iframe, page: page22 } = this.createIframeAndPage(html);
    ...
    iframe.contentWindow.document.write(page22.outerHTML);
...
var dialog_default = {
  show(html) {
    const { iframe, page: page22 } = modal_default.createIframeAndPage(html);
...
var Response = class _Response {
  ...
  preserveEqualProps(pageResponse) {
    ...
    Object.entries(pageResponse.props).forEach(([key2, value]) => {
      if (isEqual_default(value, currentPageProps[key2])) {
      ...
      const deepMerge = (target, source, matchProp) => {
        ...
        if (typeof source === "object" && source !== null) {
          return Object.keys(source).reduce(
            (acc, key2) => {
              acc[key2] = deepMerge(target ? target[key2] : void 0, source[key2], `${matchProp}.${key2}`);
              return acc;
            },
            { ...target }
          );
  ...
  hasUniqueProperty(item, property2) {
    return item && typeof item === "object" && property2 in item;
  }
...
var Request = class _Request {
  constructor(params, page22) {
    this.page = page22;
    this.requestHasFinished = false;
    this.requestParams = RequestParams.create(params);
    this.cancelToken = new AbortController();
  }
  static create(params, page22) {
    return new _Request(params, page22);
  }
  async send() {
  ...
  getHeaders() {
    ...
    const page22 = page.get();
    if (page22.version) {
      headers["X-Inertia-Version"] = page22.version;
    }
    const onceProps = Object.entries(page22.onceProps || {}).filter(([, onceProp]) => !onceProp.expiresAt || onceProp.expiresAt > Date.now()).map(([key2]) => key2);
...
var Router = class {
  ...
  resolveComponent(component2) {
    return page.resolve(component2);
  }
  replace(params) {
  ...
  performClientVisit(params, { replace: replace2 = false } = {}) {
    ...
    const preserveScroll = RequestParams.resolvePreserveOption(params.preserveScroll ?? false, page22);
    const preserveState = RequestParams.resolvePreserveOption(params.preserveState ?? false, page22);
    return page.set(page22, {
      replace: replace2,
      preserveScroll,
      preserveState,
      viewTransition
...
var getScrollableParent = (element) => {
  ...
  while (parent2) {
    const allowsScroll = allowsVerticalScroll(parent2) || allowsHorizontalScroll(parent2);
    if (window.getComputedStyle(parent2).display !== "contents" && allowsScroll) {
      return parent2;
    }
...
var requestAnimationFrame = (cb, times2 = 1) => {
  window.requestAnimationFrame(() => {
    if (times2 > 1) {
      requestAnimationFrame(cb, times2 - 1);
    } else {
      cb();
    }
  });
...
function undotKey(key2) {
  ...
  return key2.replace(/\\\./g, "__ESCAPED_DOT__").split(/(\[[^\]]*\])/).filter(Boolean).map(transformSegment).join("").replace(/__ESCAPED_DOT__/g, ".");
}
function parseKey(key2) {
  const path = [];
  const pattern = /([^\[\]]+)|\[(\d*)\]/g;
  let match;
  while ((match = pattern.exec(key2)) !== null) {
    if (match[1] !== void 0) {
      path.push(match[1]);
...
function convertSequentialObjectsToArrays(value) {
  ...
  if (objectHasSequentialNumericKeys(value)) {
    ...
    for (let i = 0; i < Object.keys(value).length; i++) {
      result22[i] = convertSequentialObjectsToArrays(value[i]);
    }
    return result22;
  }
  const result2 = {};
  for (const key2 in value) {
    result2[key2] = convertSequentialObjectsToArrays(value[key2]);
  }
  return result2;
}
function formDataToObject(source) {
  ...
  for (const [key2, value] of source.entries()) {
    ...
    const path = parseKey(undotKey(key2));
...
var Renderer = {
  ...
  findMatchingElementIndex(element, elements) {
    ...
    const key2 = element.getAttribute(attribute);
    if (key2 !== null) {
      return elements.findIndex((element2) => element2.getAttribute(attribute) === key2);
    }
    return -1;
  },
...
var useInfiniteScrollData = (options) => {
  ...
  const fetchPage = (side, reloadOptions = {}) => {
    const page22 = findPageToLoad(side);
    if (state.loading || page22 === null) {
      return;
    }
    state.loading = true;
    router.reload({
      ...reloadOptions,
      data: { [getPageName()]: page22 },
...
var useInfiniteScrollElementManager = (options) => {
  ...
  const rememberElements = () => {
    ...
    for (let index = 0; index < childNodes.length; index++) {
      ...
      const page22 = getPageFromElement(node);
      if (typeof page22 === "undefined") {
        continue;
      }
      if (!(page22 in pageElementRange)) {
        pageElementRange[page22] = { from: index, to: index };
      } else {
        pageElementRange[page22].to = index;
      }
    }
  ...
  const restoreElements = () => {
    ...
    for (let index = 0; index < childNodes.length; index++) {
      ...
      const element = node;
      let elementPage;
      for (const [page22, range2] of Object.entries(pageElementRange)) {
...
var useInfiniteScrollQueryString = (options) => {
    ...
    queue3.add(() => {
      return new Promise((resolve) => {
        ...
        if (page22 === "1") {
          ...
          searchParams.set(pageName, page22);
        }
        setTimeout(() => resolve());
      });
    }).finally(() => {
  ...
  const onItemIntersected = debounce2((itemElement) => {
    ...
    getElementsInViewportFromCollection(elements, itemElement).forEach((element) => {
      const page22 = getPageFromElement(element) ?? "1";
      if (pageMap.has(page22)) {
        pageMap.set(page22, pageMap.get(page22) + 1);
      } else {
        pageMap.set(page22, 1);
      }
    });
...
function useInfiniteScroll(options) {
  ...
  const addScrollPreservationCallbacks = (reloadOptions) => {
    ...
    reloadOptions.onBeforeUpdate = (page22) => {
      originalOnBeforeUpdate(page22);
      captureScrollPosition();
    };
    reloadOptions.onSuccess = (page22) => {
      originalOnSuccess(page22);
      restoreScrollPosition();
    };
...
var increaseByRandom = (amount) => {
  ...
  return set5(clamp2(n + amount, 0, 0.994));
};
...
function addEventListeners(delay2) {
  document.addEventListener("inertia:start", (e) => handleStartEvent(e, delay2));
  document.addEventListener("inertia:progress", handleProgressEvent);
}
function handleStartEvent(event, delay2) {
  if (!event.detail.visit.showProgress) {
    progress.hide();
  }
  const timeout = setTimeout(() => progress.start(), delay2);
        ...
        () => {
          router.remember(
            rememberable.reduce(
              (data, key3) => ({
                ...data,
                [key3]: cloneDeep_default(hasCallbacks(key3) ? this[key3].__remember() : this[key3])
              }),
              {}
            ),
            rememberKey
...
function useForm(rememberKeyOrData, maybeData) {
  ...
  let defaults2 = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(data);
  let cancelToken = null;
  let recentlySuccessfulTimeoutId;
  let transform2 = (data2) => data2;
  let defaultsCalledInOnSuccess = false;
  const form = reactive({
    ...restored ? restored.data : cloneDeep_default(defaults2),
    isDirty: false,
    ...
    data() {
      return Object.keys(defaults2).reduce((carry, key2) => {
        return set_default(carry, key2, get_default(this, key2));
      }, {});
    },
    transform(callback) {
      transform2 = callback;
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        defaults2 = cloneDeep_default(this.data());
        this.isDirty = false;
      } else {
        defaults2 = typeof fieldOrFields === "string" ? set_default(cloneDeep_default(defaults2), fieldOrFields, maybeValue) : Object.assign({}, cloneDeep_default(defaults2), fieldOrFields);
      }
      return this;
    },
    reset(...fields) {
      const resolvedData = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(defaults2);
      const clonedData = cloneDeep_default(resolvedData);
      if (fields.length === 0) {
        defaults2 = clonedData;
        Object.assign(this, resolvedData);
      } else {
        ;
        fields.filter((key2) => has_default(clonedData, key2)).forEach((key2) => {
          set_default(defaults2, key2, get_default(clonedData, key2));
          set_default(this, key2, get_default(resolvedData, key2));
        });
      }
      return this;
    },
    ...
    submit(...args) {
      ...
      const _options = {
        ...
        onSuccess: async (page22) => {
          ...
          const onSuccess = options.onSuccess ? await options.onSuccess(page22) : null;
      ...
      const transformedData = transform2(this.data());
      if (method2 === "delete") {
        router.delete(url, { ..._options, data: transformedData });
      } else {
        router[method2](url, transformedData, _options);
      }
    },
    get(url, options) {
  ...
  watch(
    form,
    (newValue) => {
      form.isDirty = !isEqual_default(form.data(), defaults2);
      if (rememberKey) {
        router.remember(cloneDeep_default(newValue.__remember()), rememberKey);
      }
    },
    { immediate: true, deep: true }
  );
      ...
      if (component.value) {
        ...
        if (component.value.layout) {
          ...
          return (Array.isArray(component.value.layout) ? component.value.layout : [component.value.layout]).concat(child).reverse().reduce((child2, layout2) => {
            ...
            return h(layout2, { ...page2.value.props }, () => child2);
          });
        }
        return child;
      }
...
var plugin = {
  install(app) {
    ...
    Object.defineProperty(app.config.globalProperties, "$page", { get: () => page2.value });
...
function usePage() {
  return reactive({
    props: computed(() => page2.value?.props),
    url: computed(() => page2.value?.url),
    component: computed(() => page2.value?.component),
    version: computed(() => page2.value?.version),
    clearHistory: computed(() => page2.value?.clearHistory),
    deferredProps: computed(() => page2.value?.deferredProps),
    mergeProps: computed(() => page2.value?.mergeProps),
    prependProps: computed(() => page2.value?.prependProps),
    deepMergeProps: computed(() => page2.value?.deepMergeProps),
    matchPropsOn: computed(() => page2.value?.matchPropsOn),
    rememberedState: computed(() => page2.value?.rememberedState),
    encryptHistory: computed(() => page2.value?.encryptHistory)
  });
}
async function createInertiaApp({
  ...
  const initialPage = page22 || getInitialPageFromDOM(id, useScriptElementForInitialPage);
  ...
  const vueApp = await Promise.all([
    ...
    if (isServer2) {
      ...
      return ssrSetup({
        el: null,
        App: app_default,
        props: { ...props, onHeadUpdate: (elements) => head2 = elements },
        plugin
      });
    }
...
var Form = defineComponent({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    const onFormUpdate = (event) => {
      isDirty.value = event.type === "reset" ? false : !isEqual_default(getData2(), formDataToObject(defaultData.value));
    };
    ...
    const submit = () => {
      ...
      form.transform(() => props.transform(data)).submit(method2.value, action, submitOptions);
    };
    const reset = (...fields) => {
...
var InfiniteScroll = defineComponent({
  name: "InfiniteScroll",
  slots: Object,
  props: {
    data: {
...
var Link = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    const as = computed(() => {
      ...
      return method2.value !== "get" ? "button" : props.as.toLowerCase();
    });
    ...
    const baseParams = computed(() => ({
      ...
      preserveState: props.preserveState ?? method2.value !== "get",
...
function usePoll(interval, requestOptions = {}, options = {
  ...
  const { stop, start: start2 } = router.poll(interval, requestOptions, {
    ...options,
    autoStart: false
  });
  onMounted(() => {
...
function useRemember(data, key2) {
  ...
  watch(
    remembered,
    (newValue) => {
      router.remember(cloneDeep_default(hasCallbacks ? data.__remember() : newValue), key2);
    },
    { immediate: true, deep: true }
  );
  return remembered;
...
var whenVisible_default = defineComponent({
  ...
  created() {
    const page22 = usePage();
    this.$watch(
      () => {
        return Array.isArray(this.data) ? this.data.map((data) => page22.props[data]) : page22.props[this.data];
      },
      (value) => {
        if (Array.isArray(this.data)) {
          if (this.data.every((data) => page22.props[data] !== void 0)) {
            return;
          }
